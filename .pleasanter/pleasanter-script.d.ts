// Generated by Pleasanter Code Assist.
// Do not edit this file manually. It may be replaced when the directories are created again.
// Environment: Script
export {};
...
// Pleasanter Code Assist で追加する jQuery の型定義です。
// このファイルはビルド時に pleasanter-script.d.ts の末尾へ追記されます。
// Pleasanter本体側は node_modules の @types/jquery で解決するため、本体側には含めません。

/**
 * jQueryオブジェクトです。
 *
 * @remarks スクリプトでよく使うメソッドのみ型を定義しています。
 * ここに定義していないメソッドも呼び出せますが、補完は表示されません。
 */
interface JQuery {
    /** 対象の値を取得します。 */
    ...
    /** CSSクラスを削除します。classNameを省略するとすべて削除します。 */
    removeClass(className?: string): JQuery;
    /** 指定したCSSクラスを持つ場合はtrueを返します。 */
    ...
    /** 上記以外のjQueryのメソッドも呼び出せます（補完は表示されません）。 */
    [name: string]: any;
}
